-- ============================================================
-- 예견 (YEGYEON) — 약관 문서 재시드 (012의 시드가 적용되지 않은 환경 보정)
-- 마이그레이션 014
-- 정책: content가 비어있거나 매우 짧으면 표준 템플릿으로 강제 갱신.
--       관리자가 어드민 페이지에서 직접 작성한 경우(=내용이 충분히 긴 경우)는 보존.
-- ============================================================
...
ON CONFLICT (kind) DO UPDATE
  ...
  WHERE coalesce(length(public.legal_documents.content), 0) < 200;
