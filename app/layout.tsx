...
const SITE_DESC =
  '예견(YEGYEON)은 누구나 미래 사건에 질문을 만들고, 내부 포인트로 예측에 베팅하는 한국형 예측 시장 플랫폼입니다. 정치·경제·스포츠·연예·코인·기술·게임 등 다양한 주제의 마켓에서 집단지성으로 확률을 예측하고, 정확한 예측에 보상이 따릅니다. 실제 화폐 거래 없이 안전하게 예측 게임을 즐겨보세요.'
...
const SEO_KEYWORDS = [
  ...
  '맨이폴드 한국', '폴리마켓 한국',
  // 기능/액션
  '베팅', '베팅 사이트', '확률 베팅', '미래 베팅', '온라인 베팅', '재미있는 베팅',
  'YES NO 베팅', 'YES/NO', '예스 노 베팅', '바이너리 마켓',
